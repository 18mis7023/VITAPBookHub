...
class CivilRecyclerAdapter(val context: Context, val itemList:ArrayList<Book>) : RecyclerView.Adapter<CivilRecyclerAdapter.CivilViewHolder>(){
    class CivilViewHolder(view: View): RecyclerView.ViewHolder(view){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CivilViewHolder {
        val view= LayoutInflater.from(parent.context).inflate(R.layout.recycler_home_single_row,parent,false)

        return CivilViewHolder(view)
    }
    ...
    override fun onBindViewHolder(holder: CivilViewHolder, position: Int)  {
