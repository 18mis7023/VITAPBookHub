...
class DbmsRecyclerAdapter(val context: Context, val itemList:ArrayList<InterviewBook>) : RecyclerView.Adapter<DbmsRecyclerAdapter.DbmsViewHolder>() {
    class DbmsViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    override fun onBindViewHolder(holder: DbmsViewHolder, position: Int)  {
