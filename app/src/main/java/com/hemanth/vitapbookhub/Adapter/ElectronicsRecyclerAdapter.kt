...
class ElectronicsRecyclerAdapter (val context: Context, val itemList:ArrayList<Book>) : RecyclerView.Adapter<ElectronicsRecyclerAdapter.ElectronicsViewHolder>() {
