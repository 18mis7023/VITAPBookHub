...
class AlgorithimsRecyclerAdapter(val context: Context, val itemList:ArrayList<InterviewBook>) : RecyclerView.Adapter<AlgorithimsRecyclerAdapter.AlgorithimsViewHolder>() {
    class AlgorithimsViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        val bookid:Int=0
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): AlgorithimsViewHolder {
        val view= LayoutInflater.from(parent.context).inflate(R.layout.recycler_interview_single_row,parent,false)

        return AlgorithimsViewHolder(view)
    }
    ...
    override fun onBindViewHolder(holder: AlgorithimsViewHolder, position: Int)  {
