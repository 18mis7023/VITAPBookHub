...
class LogicalRecyclerAdapter (val context: Context, val itemList:ArrayList<InterviewBook>) : RecyclerView.Adapter<LogicalRecyclerAdapter.LogicalViewHolder>() {
    class LogicalViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): LogicalViewHolder {
        val view= LayoutInflater.from(parent.context).inflate(R.layout.recycler_interview_single_row,parent,false)

        return LogicalViewHolder(view)
    }
    ...
    override fun onBindViewHolder(holder: LogicalViewHolder, position: Int)  {
