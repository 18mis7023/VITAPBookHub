...
class QuantitativeRecyclerAdapter(val context: Context, val itemList:ArrayList<InterviewBook>) : RecyclerView.Adapter<QuantitativeRecyclerAdapter.QuantitativeViewHolder>() {
    class QuantitativeViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): QuantitativeViewHolder {
    ...
    override fun onBindViewHolder(holder: QuantitativeViewHolder, position: Int)  {
