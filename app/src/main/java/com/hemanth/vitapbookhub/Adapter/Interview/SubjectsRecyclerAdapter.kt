...
class SubjectsRecyclerAdapter(val context: Context, val itemList:ArrayList<InterviewBook>) : RecyclerView.Adapter<SubjectsRecyclerAdapter.SubjectsViewHolder>() {
