...
class VerbalRecyclerAdapter(val context: Context, val itemList:ArrayList<InterviewBook>) : RecyclerView.Adapter<VerbalRecyclerAdapter.VerbalViewHolder>() {
    class VerbalViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VerbalViewHolder {
        val view= LayoutInflater.from(parent.context).inflate(R.layout.recycler_interview_single_row,parent,false)

        return VerbalViewHolder(view)
    }
    ...
    override fun onBindViewHolder(holder: VerbalViewHolder, position: Int)  {
