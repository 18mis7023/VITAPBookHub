...
class WebDevelopmentRecyclerAdapter(val context: Context, val itemList:ArrayList<InterviewBook>) : RecyclerView.Adapter<WebDevelopmentRecyclerAdapter.WebDevelopmentViewHolder>() {
    class WebDevelopmentViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        val bookid:Int=0
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): WebDevelopmentViewHolder {
        val view= LayoutInflater.from(parent.context).inflate(R.layout.recycler_interview_single_row,parent,false)

        return WebDevelopmentViewHolder(view)
    }
    ...
    override fun onBindViewHolder(holder: WebDevelopmentViewHolder, position: Int)  {
