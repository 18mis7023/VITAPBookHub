...
class JournalsRecyclerAdapter (val context: Context, val itemList:ArrayList<Book>) : RecyclerView.Adapter<JournalsRecyclerAdapter.JournalsViewHolder>() {
    class JournalsViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): JournalsViewHolder {
        val view= LayoutInflater.from(parent.context).inflate(R.layout.recycler_home_single_row,parent,false)

        return JournalsViewHolder(view)
    }
    ...
    override fun onBindViewHolder(holder: JournalsViewHolder, position: Int)  {
