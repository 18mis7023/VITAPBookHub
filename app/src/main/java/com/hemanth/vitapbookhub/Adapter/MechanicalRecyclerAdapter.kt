...
class MechanicalRecyclerAdapter(val context: Context, val itemList:ArrayList<Book>) : RecyclerView.Adapter<MechanicalRecyclerAdapter.MechanicalViewHolder>() {
    class MechanicalViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MechanicalViewHolder {
        val view= LayoutInflater.from(parent.context).inflate(R.layout.recycler_home_single_row,parent,false)

        return MechanicalViewHolder(view)
    }
    ...
    override fun onBindViewHolder(holder: MechanicalViewHolder, position: Int)  {
