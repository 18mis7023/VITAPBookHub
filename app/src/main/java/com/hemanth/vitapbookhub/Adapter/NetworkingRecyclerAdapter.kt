...
class NetworkingRecyclerAdapter(val context: Context, val itemList:ArrayList<InterviewBook>) : RecyclerView.Adapter<NetworkingRecyclerAdapter.NetworkingViewHolder>() {
    class NetworkingViewHolder(view: View) : RecyclerView.ViewHolder(view) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NetworkingViewHolder {
        val view= LayoutInflater.from(parent.context).inflate(R.layout.recycler_interview_single_row,parent,false)

        return NetworkingViewHolder(view)
    }
    ...
    override fun onBindViewHolder(holder: NetworkingViewHolder, position: Int)  {
